...
<main class="w-full relative overflow-hidden bg-[#FDFBF3]">
  ...
  <div class="hidden xl:block w-full">
    ...
    <section class="w-full relative overflow-hidden min-h-[720px] bg-[#FDFBF3] pt-3 pb-16">
      ...
      <div class="relative z-10 max-w-[1240px] mx-auto px-6 sm:px-10 md:px-14 lg:px-16 pt-16 pb-16 flex items-center justify-start">
    ...
    <!-- 2. DESKTOP EXPLORE INGREDIENT SOLUTIONS SECTION -->
    <section class="w-full relative overflow-hidden py-16 px-[80px]"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 w-full">
          ...
          <div class="bg-white rounded-tl-[36px] rounded-br-[36px] rounded-tr-[4px] rounded-bl-[4px] p-5 shadow-md flex items-center gap-5 min-h-[236px]">
            <div class="w-[144px] h-[198px] relative shrink-0 rounded-tl-none rounded-br-none overflow-hidden" style="border-top-left-radius: 6.33px; border-bottom-right-radius: 6.33px;">
              <img src="<?php echo esc_url( get_template_directory_uri() . '/public/assets/food-rice.png' ); ?>" alt="Rice Biopolymer" class="w-full h-full object-cover">
            </div>
            <div class="flex flex-col justify-between h-full py-1 gap-3">
              <div class="flex flex-col gap-2">
                <h3 class="font-montserrat font-bold text-[22px] leading-[32.73px] text-[#5D3700]">Rice Biopolymer</h3>
                <p class="font-montserrat font-normal text-[15px] lg:text-[18px] leading-[25.34px] text-black/80">
                  Natural texturizer and film-former providing sensory elegance and velvet finish.
                </p>
              </div>
          ...
          <!-- Card 02: Hydrolyzed Rice Protein -->
          <div class="bg-white rounded-tl-[36px] rounded-br-[36px] rounded-tr-[4px] rounded-bl-[4px] p-5 shadow-md flex items-center gap-5 min-h-[236px]">
            <div class="w-[144px] h-[198px] relative shrink-0 rounded-tl-none rounded-br-none overflow-hidden" style="border-top-left-radius: 6.33px; border-bottom-right-radius: 6.33px;">
              <img src="<?php echo esc_url( get_template_directory_uri() . '/public/assets/food-rice.png' ); ?>" alt="Hydrolyzed Rice Protein" class="w-full h-full object-cover">
            </div>
            <div class="flex flex-col justify-between h-full py-1 gap-3">
              <div class="flex flex-col gap-2">
                <h3 class="font-montserrat font-bold text-[22px] leading-[32.73px] text-[#5D3700]">Hydrolyzed Rice Protein</h3>
                <p class="font-montserrat font-normal text-[15px] lg:text-[18px] leading-[25.34px] text-black/80">
                  Nutrient-rich protein hydrolysate enhancing hair volume and skin hydration.
                </p>
              </div>
              <div class="flex flex-col gap-2 items-start">
                <span class="bg-[#FBEAC4] text-[#5D3700] rounded-[11.61px] px-[10.56px] py-[3.17px] font-montserrat font-medium text-[14.78px] leading-[23.23px]">
          ...
          <div class="bg-white rounded-tl-[36px] rounded-br-[36px] rounded-tr-[4px] rounded-bl-[4px] p-5 shadow-md flex items-center gap-5 min-h-[236px]">
            ...
            <div class="flex flex-col justify-between h-full py-1 gap-3">
              <div class="flex flex-col gap-2">
                ...
                <p class="font-montserrat font-normal text-[15px] lg:text-[18px] leading-[25.34px] text-black/80">
                  Plant-based carrier and stabilizing agent for active cosmetic ingredients.
                </p>
              </div>
              <div class="flex flex-col gap-2 items-start">
                <span class="bg-[#FBEAC4] text-[#5D3700] rounded-[11.61px] px-[10.56px] py-[3.17px] font-montserrat font-medium text-[14.78px] leading-[23.23px]">
    ...
    <!-- 3. DESKTOP FREQUENTLY ASKED QUESTIONS SECTION -->
  ...
  <div class="block xl:hidden w-full">
    ...
    <section class="w-full relative overflow-hidden bg-[#FDFBF3] min-h-[580px] pt-6 pb-8 px-5 flex flex-col justify-between items-center text-center">
      ...
      <!-- Full Cover Background Image -->
      <div class="absolute inset-0 w-full h-full z-0 pointer-events-none">
        <img src="<?php echo esc_url( get_template_directory_uri() . '/public/assets/cosmitics-hero-small.jpg' ); ?>" alt="Cosmetics &amp; Personal Care" class="w-full h-full object-cover object-[right_center]">
      </div>
      ...
      <div class="relative z-10 flex flex-col items-center justify-between text-center w-full max-w-[351px] min-h-[520px] my-auto mx-auto pt-2 pb-2">
        ...
        <!-- Category Tag -->
        <span class="font-montserrat font-bold text-[12px] leading-[22px] tracking-[0.11em] uppercase text-black text-center whitespace-nowrap w-auto mt-2 mb-[48px]">
          COSMETICS &amp; PERSONAL CARE
        </span>
        ...
        <div class="flex flex-col items-center justify-center text-center w-full max-w-[351px] my-auto">
          ...
          <h1 class="font-bold text-[30px] sm:text-[32px] leading-[36px] sm:leading-[38.4px] text-black text-center w-[351px] max-w-full my-auto"
            ...
            Performance You Can<br>Feel. Ingredients You<br>
            <span class="text-[#00A256]">Can Trust.</span>
          </h1>
        ...
        <div class="flex flex-col gap-4 w-full">
          ...
          <div class="bg-white rounded-[20px] p-3.5 shadow-md flex flex-row items-center gap-3.5 w-full">
            <div class="w-[125px] h-[165px] shrink-0 rounded-[12px] overflow-hidden flex items-center justify-center bg-gray-50">
              <img src="<?php echo esc_url( get_template_directory_uri() . '/public/assets/food-rice.png' ); ?>" alt="Rice Biopolymer" class="w-full h-full object-contain">
            </div>
            <div class="flex flex-col justify-between flex-1 min-w-0">
              <h3 class="font-montserrat font-bold text-[15px] text-[#5D3700] leading-tight mb-1 truncate">Rice Biopolymer</h3>
              <p class="font-montserrat text-[11px] leading-[15px] text-black/75 mb-2 line-clamp-3">Natural texturizer and film-former providing sensory elegance and velvet finish.</p>
              <span class="bg-[#FBEAC4] text-[#5D3700] rounded-[6px] px-2 py-0.5 font-montserrat font-medium text-[10px] w-fit mb-2">Skincare • Cosmetics</span>
          ...
          <div class="bg-white rounded-[20px] p-3.5 shadow-md flex flex-row items-center gap-3.5 w-full">
            <div class="w-[125px] h-[165px] shrink-0 rounded-[12px] overflow-hidden flex items-center justify-center bg-gray-50">
              <img src="<?php echo esc_url( get_template_directory_uri() . '/public/assets/food-rice.png' ); ?>" alt="Hydrolyzed Rice Protein" class="w-full h-full object-contain">
            </div>
            <div class="flex flex-col justify-between flex-1 min-w-0">
              <h3 class="font-montserrat font-bold text-[15px] text-[#5D3700] leading-tight mb-1 truncate">Hydrolyzed Rice Protein</h3>
              <p class="font-montserrat text-[11px] leading-[15px] text-black/75 mb-2 line-clamp-3">Nutrient-rich protein hydrolysate enhancing hair volume and skin hydration.</p>
              <span class="bg-[#FBEAC4] text-[#5D3700] rounded-[6px] px-2 py-0.5 font-montserrat font-medium text-[10px] w-fit mb-2">Haircare • Personal Care</span>
              <a href="<?php echo esc_url( site_url( '/product/rice-starch' ) ); ?>" class="font-montserrat font-bold text-[12px] text-[#FF8D00] inline-flex items-center gap-0.5">View Details &gt;</a>
            </div>
          </div>
          ...
          <div class="bg-white rounded-[20px] p-3.5 shadow-md flex flex-row items-center gap-3.5 w-full">
            ...
            <div class="flex flex-col justify-between flex-1 min-w-0">
              ...
              <p class="font-montserrat text-[11px] leading-[15px] text-black/75 mb-2 line-clamp-3">Plant-based carrier and stabilizing agent for active cosmetic ingredients.</p>
              <span class="bg-[#FBEAC4] text-[#5D3700] rounded-[6px] px-2 py-0.5 font-montserrat font-medium text-[10px] w-fit mb-2">Personal Care • Formulations</span>
              <a href="<?php echo esc_url( site_url( '/product/rice-starch' ) ); ?>" class="font-montserrat font-bold text-[12px] text-[#FF8D00] inline-flex items-center gap-0.5">View Details &gt;</a>
            </div>
          </div>

          <!-- Card 04: Orange CTA Special Card -->
