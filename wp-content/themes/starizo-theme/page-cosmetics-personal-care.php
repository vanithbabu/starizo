...
<main class="w-full relative overflow-hidden bg-[#FDFBF3]">
  ...
  <!-- Mobile Layout View (<1024px / <1280px screens - 1:1 Matched with cosmetics-personal-care.html) -->
  <div class="block lg:hidden w-full">
    ...
    <section class="w-full relative overflow-hidden bg-[#FDFBF3] min-h-[580px] pt-6 pb-8 px-5 flex flex-col justify-between items-center text-center">
      ...
      <div class="absolute inset-0 w-full h-full z-0 pointer-events-none">
        <img src="<?php echo esc_url( get_template_directory_uri() . '/public/assets/consmitics-hero.png' ); ?>" alt="Cosmetics & Personal Care" class="w-full h-full object-cover object-[right_center]">
      </div>
