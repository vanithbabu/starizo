  ...
  <div class="max-w-7xl mx-auto px-6 md:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
    ...
    <div class="lg:col-span-6 flex flex-col space-y-6">
      ...
      <a href="<?php echo esc_url($button_link); ?>"
        class="group bg-[#FF8D00] hover:bg-gradient-to-r hover:from-[#FF8D00] hover:to-[#FFB457] text-white font-semibold text-[18px] w-fit px-8 h-[48px] rounded-full hover:scale-[1.03] active:scale-[0.98] transition-all duration-300 shadow-md hover:shadow-xl select-none flex items-center gap-2">
