      ...
      <div class="absolute left-1/2 -translate-x-1/2 top-0 w-[1280px] h-[800px]">
        ...
        <div class="absolute left-[79px] top-[305px] w-[534px] z-10 flex flex-col items-start">
          ...
          <a href="<?php echo esc_url($button_link); ?>"
            class="w-auto px-8 h-[45px] bg-[#FF8D00] hover:bg-[#E07C00] text-white font-semibold text-[18px] rounded-[22px] shadow-[0px_4px_12px_rgba(255,141,0,0.3)] transition-all duration-300 flex items-center justify-center gap-2 group">
